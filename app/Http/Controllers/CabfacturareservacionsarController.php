...
class CabfacturareservacionsarController extends Controller
{
    /**
    ...
    public function anularReservacionSar($num_fact){
        if ($this->rol->eliminar == "N") {
            return redirect()->route('dashboard')->with('nopermiso', 'No tienes permiso para acceder a la información solicitada.');
        }
        $factura = cabfacturareservacionsar::where('factnum', $num_fact)->first();
        $factura->anular = 'S';
        $factura->save();
    ...
    public function store(Request $request)
    {
       ...
       // dd($request);
        ...
        $cabfactura = new cabfacturareservacionsar();
        ...
        if ($servicio) {
            $detalle = new detafacturareservacionsar();
        ...
        if ($imprimir_flag) {
            return redirect()->route('facturas.rptfacturareservacionsar', $cabfactura->factnum)->with('etiqueta', 'ORIGINAL');
        } else {
     ...
     */
    public function show(cabfacturareservacionsar $cabfacturareservacionsar)
    {
        //
    }
     ...
     */
    public function edit(cabfacturareservacionsar $cabfacturareservacionsar)
    {
        //
    }
     ...
     */
    public function update(Request $request, cabfacturareservacionsar $cabfacturareservacionsar)
    {
        //
    }
     ...
     */
    public function destroy(cabfacturareservacionsar $cabfacturareservacionsar)
    {
        //
    }
}
