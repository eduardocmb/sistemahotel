...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Editar Cuenta por Pagar</div>
                        ...
                        <form action="{{ route('cuentas.update', $cuenta->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input readonly type="text" name="codigo" id="codigo"
                                        class="form-control @error('codigo') is-invalid @enderror"
                                        value="{{ old('codigo', $cuenta->codigo) }}" maxlength="9">
                                    @error('codigo')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="numfactura" id="numfactura"
                                        ...
                                        value="{{ old('numfactura', $cuenta->numfactura) }}" maxlength="50">
                                    @error('numfactura')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="estado" id="estado"
                                        ...
                                        <option value="PENDIENTE" {{ old('estado', $cuenta->estado) == 'PENDIENTE' ? 'selected' : '' }}>
                                            PENDIENTE</option>
                                        <option value="PAGADO" {{ old('estado', $cuenta->estado) == 'PAGADO' ? 'selected' : '' }}>PAGADO
                                        </option>
                                    </select>
                                    @error('estado')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea name="notas" id="notas" class="form-control @error('notas') is-invalid @enderror" rows="3">{{ old('notas', $cuenta->notas) }}</textarea>
                                    @error('notas')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
