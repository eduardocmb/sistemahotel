...
@section('content_header')
    ...
    <a class="my-2 btn btn-primary btn-sm" href="{{ route('lotes.insumos.create', $producto->codigo)}}">
        <i class="fas fa-plus-circle"></i> Agregar Nuevo Lote
    </a>
    <a href="{{ route('insumo.index') }}" class="ml-2 btn btn-sm text-light btn-secondary">
    ...
    <script>
        $(function() {
            $('#tablaLotes').DataTable({
                ...
                ajax: "/datatables/lotesinsumos/{{ $producto->codigo }}",
                columns: [{
                        data: "id"
                    },
                    {
