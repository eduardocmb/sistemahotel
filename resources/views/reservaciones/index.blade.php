...
@section('content_header')
    ...
    <div class="row">
        <div class="col-3"><a class="my-2 btn btn-primary btm-sm" href="{{ route('reservaciones.create') }}">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <button id="btnImprimir" class="btn mx-2 btn-sm btn-primary">
...
@section('js')
    ...
    <script>
        document.getElementById('btnImprimir').addEventListener('click', function() {
            ...
            enlace.href = `{{ route('rpt.imprimirReservacionesGeneral') }}`;
            ...
            $('#tablaReservas').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: null,
                        render: function(data, type, row) {
                            let editUrl = "{{ route('reservacione.edit', ':id') }}".replace(':id',
                                row.id);
...
@endif
            ...
            <div class="modal-footer">
                <a href="{{ route('rptReservacionSar', session('reserv') ?? '') }}" class="btn btn-primary">
                    <i class="fas fa-print"></i> Imprimir
                </a>
