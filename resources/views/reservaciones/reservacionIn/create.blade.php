                                            ...
                                            @foreach ($servicios as $servicio)
                                                <tr>
                                                    <td><input type="hidden"
                                                            name="servicios[{{ $index }}][nombre_servicio]">{{ $servicio->nombre }}
                                                            <input type="hidden" value="{{$servicio->id}}" name="servicios[{{ $index }}][id]">
                                                    </td>
                                                    <td><input type="hidden"
                                                            name="servicios[{{ $index }}][precio_servicio]">{{ $servicio->precio_venta }}
                                                        Lps.</td>
                                                        <td>
                                                            <input type="number" name="servicios[{{ $index }}][cantidad]" class="form-control" min="0"
                                                                   value="{{ old('servicios.' . $index . '.cantidad', 0) }}"
                                                                   oninput="const input = event.target;
                                                    ...
                                                    <td><input type="hidden"
                                                            name="servicios[{{ $index }}][total]"><span></span>
                                                    </td>
                                                    <td>
                                                        <input type="checkbox"
                                                            name="servicios[{{ $index }}][seleccionado]"
                                                            {{ old('servicios.' . $index . '.seleccionado') == 1 ? 'checked' : '' }}
                                                            value="1">
                                                    </td>
                                                </tr>
                                                @php $index++; @endphp
