            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" id="username" maxlength="20" required value="{{ old('username') }}">
                        @error('username')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" oninput="this.value = this.value.toUpperCase()" class="form-control @error('name') is-invalid @enderror" name="name" id="name" required value="{{ old('name') }}">
                        @error('name')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control @error('idrol') is-invalid @enderror" name="idrol" id="idrol" required>
                            ...
                            @foreach ($roles as $rol)
                                <option value="{{ $rol->codigo }}" {{ old('idrol') == $rol->codigo ? 'selected' : '' }}>
                                    {{ $rol->rol }}
                                </option>
                            @endforeach
                        </select>
