...
@section('js')
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('guardarImprimir').addEventListener('click', function() {
                ...
                if (etiqueta) {
                    ...
                    enlace.href = '{{ route('facturasin.rptfacturaIn', $factura[0]->cab_id) }}' +
    ...
    <script>
        ...
        btnAnular.addEventListener('click', async function() {
            ...
            const url = `/anular/factura/${factnum}/int`;
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form id="anularFacturaForm" method="GET">
                    <button type="submit" data-factnum="{{ $factura[0]->cab_id }}" class="btn btn-danger"
                        id="confirmAnularBtn">Anular</button>
                    <input type="hidden" name="factnum" value="{{ $factura[0]->cab_id }}" id="factnumInput">
                </form>
            </div>
        </div>
    </div>
