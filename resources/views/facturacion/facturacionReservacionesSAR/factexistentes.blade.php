    ...
    <script>
        $(function() {
            $('#tablaFacturas').DataTable({
                ...
                ajax: "{{ route('datatable.getFacturasReservacionSar') }}",
                columns: [{
                        data: "factnum"
                    },
                    {
                    ...
                    },
                    {
                        data: null,
                        render: function(data, type, row) {
                            let editUrl = "{{ route('rptReservacionSar', ':id') }}".replace(':id',
                                row
                                .numreservacion);
                            return `
    ...
    <script>
        $(function() {
            $('#tablaFacturaInt').DataTable({
                ...
                ajax: "{{ route('datatable.getFacturasReservacionInterno') }}",
                columns: [{
                        data: "id"
                    },
                    {
                    ...
                    },
                    {
                        data: null,
                        render: function(data, type, row) {
                            let editUrl = "{{ route('rptReservacionIn', ':id') }}".replace(':id',
                                row
                                .numreservacion);
                            return `
                                <a href="${editUrl}" class="btn btn-info btn-sm">
