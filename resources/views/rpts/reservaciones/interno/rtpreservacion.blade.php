...
<body>
    <div class="invoice">
        ...
        <div class="other-info">
            ...
            <h3>FACTURA {{ $etiqueta }}</h3>
            <p><strong>RANGO AUTORIZADO</strong></p>
            <p><strong>DESDE:</strong> {{ $cai->facturainicial }} | <strong>HASTA:</strong> {{ $cai->facturafinal }}
            </p>
            <p><strong>FECHA ENTRADA:</strong> {{ $factura[0]->fechaentrada }} | <strong>FECHA SALIDA:</strong> {{ $factura[0]->fechasalida }}
            </p>
        </div>
        ...
        <div class="details">
            <table>
                ...
                <tbody>
                    <tr>
                        <td>{{ $habitacion->id }}</td>
                        <td>Habitación N°:{{ $habitacion->numero_habitacion }}</td>
                        <td>{{ number_format($habitacion->precio_diario, 2) }}</td>
                        <td>
                            @php
                        ...
                        <td>----</td>
                        <td>{{ number_format($factura[0]->descto, 2) }}</td>
                        <td>
                            @php
        ...
        <div class="totals" style="margin: 15px 0 0 0;">
            <table>
                ...
                <tr style="background-color: #9c9a95">
                    <th>DESCUENTO:</th>
                    <td>{{ number_format($factura[0]->descuentogeneral, 2) }}</td>
                </tr>
                <tr style="background-color: #9c9a95">
                    <th>ISV 15%:</th>
