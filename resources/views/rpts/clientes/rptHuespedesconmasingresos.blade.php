...
<head>
    ...
    <title>Reporte de Huéspedes con Más Ingresos</title>
    <style>
        body {
...
<body>
    <div class="invoice">
        ...
        <div class="header">
            ...
            <div class="clear"></div>
            <h3>Reporte de Huéspedes con Más Ingresos</h3>
        </div>
        ...
        <div class="details">
            ...
            <h4 style="margin: 20px 0 0 0; float: right;">Total: {{ number_format($total_, 2) }} Lps</h4>
        </div>
    </div>
</body>
