        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Reporte de Productos mas Vendidos</h3>
                </div>
                <div class="card-body">
...
@section('js')
    ...
    <script>
        document.getElementById('btnImprimir').addEventListener('click', function() {
            ...
            enlace.href = `{{ route('rpt.imprimirProductosmasVendidos') }}`
        ...
        $(tableId).DataTable({
            ...
            ajax: {
                url: `{{ route('datatables.getProductosmasVendidos') }}`
            },
            columns: [{
                    data: "codproducto"
                },
